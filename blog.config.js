...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'owlcity', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Visual design\blender\after effects', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-taupe-nu.vercel.app/', // 网站地址
